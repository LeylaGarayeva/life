...
<div class="relative">
<div class="inner-position" style="width: 100%">
			<div class="page_title_wrapper">
				<h1 class="page_title">Продукция</h1>
			</div>
			<div class="middle_content clearfix">
				<div class="left_sidebar" style="width: 20%;float: left;margin-right: 5%">
						...
						<?php
 						...
 						?>
								<div class="col active col_1">
									...
									<div class="title"><div class="field_content2">
				...
				<div class="page_content" style="float: left;width: 70%">
